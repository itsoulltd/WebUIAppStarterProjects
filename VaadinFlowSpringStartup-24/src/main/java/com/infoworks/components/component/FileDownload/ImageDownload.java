package com.infoworks.components.component.FileDownload;

import com.infoworks.config.AppQueue;
import com.infoworks.config.ApplicationResources;
...
public class ImageDownload extends Div {
    ...
    private iResources resService = iResources.create();
    ...
    public ImageDownload(String baseUri, String requestUri, Property...params) {
        this.baseUri = baseUri;
    ...
    protected void onAttach(AttachEvent attachEvent) {
        ...
        if (delaysInMillis > 0l) {
            ...
            UI ui = UI.getCurrent();
            AppQueue.dispatch(delaysInMillis, TimeUnit.MILLISECONDS
